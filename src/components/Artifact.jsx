      ...
      <>
        {!collapsed ? <div className='flex flex-col h-full bg-[#0d0f14]'>
          <div className='h-14 px-4 border-b border-white/6 flex items-center gap-3 shrink-0'>
            <button className='flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-white/5 transition-colors duration-150 bg-transparent border-none cursor-pointer shrink-0' onClick={onClose ?? (() => setCollapsed(true))}>
            ...
            {canPreview &&
              <div className='flex items-center gap-1 bg-white/4 border border-white/6 p-1 rounded-1g'>
                <button
                  onClick={() => setTab("code")}
          ...
          {tab === "code" && <div className='h-auto flex border-b border-white/6 overflow-x-auto [scrollbar-width:none] [&::-webkit-scrollbar]:hidden shrink-0'>
            {
          ...
          <div className='flex-1 overflow-hidden'>
            ...
            >
              <iframe title='preview' srcDoc={previewDoc} sandbox='allow-scripts' className='w-full h-full bg-white'></iframe>
            </motion.div>
              :
              <motion.div
                initial={{ opacity: 0 }}
          ...
          <div className='hidden lg:flex h-full border-1 border-white/6 bg-[#0d0f14] flex-col items-center py-4 gap-3 shrink-0'>
            <button className='flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-white/5 transition-colors duration-150 bg-transparent border-none cursor-pointer shrink-0' onClick={() => setCollapsed(false)}>
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className='hidden lg:flex h-full border-1 border-white/6 flex-col overflow-hidden shrink-0 w-[250px]'>
