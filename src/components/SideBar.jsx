...
function SideBar() {
    ...
    return (
        <>
            ...
            <div className={`fixed lg:static inset-y-0 left-0 z-50 w-[270px] h-screen shrink-0 bg-[#0d0f14] border-r border-white/6 transition-transform duration-250
            ${mobileOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}
                ...
                ${isActive ? "bg-indigo-500/15 text-indigo-400" : " bg-white/[0.05] text-slate-500"}`}>
                    ...
                    <div className='px-3.5 py-3.5 mt-auto'>
                        {userData ? (
                            <div className='flex items-center gap-2.5 cursor-pointer rounded-xl px-3 py-2.5 hover:bg-white/[0.05] transition-colors duration-150'>
                                ...
                                <div className='flex-1 min-w-0'>
                                    <p className='tex-[13.5px] font-semibold text-slate-100 truncate'>{userData?.name || "user"}</p>
